...
public class ExampleSharedPreferencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example_shared_preferences);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.getText().toString().equalsIgnoreCase(login.getString(checkUser, null))
                    ...
                    Intent intent = new Intent(ExampleSharedPreferencesActivity.this, ExampleSharedPreferencesSecondActivity.class);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ExampleSharedPreferencesActivity.this, ExampleSharedPreferencesRegisterActivity.class);
